...
Headless web-scraper template bypassing **Cloudflare** protection. Working on **X** **v**irtual **f**rame **b**uffer (**Xvfb**) and **Perl** **WWW::Mechanize::Chrome** module, modified to not implement methods with **macOS**- or **Windows**-specific requirements.
